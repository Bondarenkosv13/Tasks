...
<head>
    ...
    <style type="text/css">
        ...
        body {background:url('/image/404.png') center no-repeat #fff}
...
<body>
<?php include_once dirname(__DIR__, 3) . '/config/functions.php' ?>
<div class="content">
    <a href="<?php echo route('/')?>">Перейти к главной странице</a>
</div>
</body>
</html>